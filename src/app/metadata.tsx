...
//             {["Home", "About Us", "Careers"]?.map(
//               (menuName: string, index: number) => {
//                 return (
//                   <li className="inline-flex" key={menuName + index}>
//                     {menuName}
//                   </li>
//                 );
//               }
...
export const metadata = {
  title: "Web-desk ERP",
  description: "This is product by Akron systems for school and collage",
};
