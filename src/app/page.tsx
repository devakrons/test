...
// //   console.log("<==== from page in root level ===>");
...
//               ]?.map(
//                 (menuName: { label: string; path: string }, index: number) => {
//                   return (
...
// LandingPageProps now ensures children is a ReactElement
interface LandingPageProps {
  children: ReactElement; // Required children as ReactElement
}
